<template>
  <div
    class="admin-login min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-indigo-900 flex flex-col justify-center py-12 sm:px-6 lg:px-8"
  >
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
      ...
      <h2 class="mt-6 text-center text-3xl font-bold text-white">Admin Login</h2>
    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
      <div
        class="bg-white py-8 px-4 shadow-2xl sm:rounded-xl sm:px-10 backdrop-blur-lg border border-white/10"
      >
